<form autocomplete="off">
    <div class="row">
        ...
        <div class="form-group form-focus col-3">
            ...
            {!! Form::label('search.title', 'Accreditation', ['class' => 'focus-label']) !!}
        </div>

        <div class="form-group form-focus col-3">
            {!! Form::select('search.country_id', $this->countryList, 'S', ['wire:model.defer' => 'search.country_id', 'class' => 'form-control input-rounded search-input select2 floating', 'placeholder' => '']) !!}
            {!! Form::label('search.country_id', 'Country', ['class' => 'focus-label']) !!}
        </div>
