...
<div>
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">System Model</li>
                    </ol>
                </div>
                <div class="col-sm-4 action-tools">
                    ...
                    <button wire:click="syncModel()" class="btn btn-sm btn-icon text-danger">
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div wire:ignore class="filter-section collapse" id="filter_collapse">
                                @include('livewire.admin.masters.system-model.system-model-filter')
                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th wire:click="sortBy('model_name')"
                                                class="{{ $this->sortFieldData['model_name']['css_class'] ?? 'sortby' }}">
                                                Model Name
                                            </th>
                                            <th wire:click="sortBy('field_name')"
                                                class="{{ $this->sortFieldData['field_name']['css_class'] ?? 'sortby' }}">
                                                Field Name
                                            </th>
                                            <th>Show in Form</th>
                                    ...
                                    <tbody>
                                        @forelse($records  as $index => $record)
                                            <tr class="{{ empty($record->active) ? ' table-disable ' : '' }}">
                                                ...
                                                <td>{{ __showValue($record->field_name) }}</td>
                                                <td>
                                                    {!! 
    ...
    <x-common.modal wire:key="{{ now() }}"
        ...
        <x-slot name="modal_body">
            @include('livewire.admin.masters.system-model.system-model-create')
        </x-slot>
    </x-common.modal>
