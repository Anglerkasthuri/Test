  ...
  <form autocomplete="off">
    <div class="row p-3">
      ...
      <div class="form-group col-lg-3">
        {!! Form::label('fdata.title', 'Program Level', ['class' => 'control-label required']) !!}
        {!! Form::text('fdata.title', old('fdata.title'), ['wire:model.defer' => 'fdata.title', 'class' => 'form-control ' . ($errors->has('fdata.title') ? ' is-invalid' : ''),  'placeholder' => 'Enter Program Level']) !!}
        @error('fdata.title')
