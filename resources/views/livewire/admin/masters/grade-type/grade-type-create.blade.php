  ...
  <form autocomplete="off">
    <div class="row p-3">
      <div class="form-group col-lg-4">
        {!! Form::label('fdata.title', 'Grade Type', ['class' => 'control-label required']) !!}
        {!! Form::text('fdata.title', "", ['wire:model.defer' => 'fdata.title', 'class' => 'form-control ' . ($errors->has('fdata.title') ? ' is-invalid' : ''), 'placeholder' => 'Ex: Pass']) !!}
        @error('fdata.title')
      ...
      <div class="form-group col-lg-4">
        ...
        {!! Form::text('fdata.code', "", ['wire:model.defer' => 'fdata.code', 'class' => 'form-control ' . ($errors->has('fdata.code') ? ' is-invalid' : ''), 'placeholder' => 'Ex: P']) !!}
        @error('fdata.code')
            <span class="error invalid-feedback">{{ $message }}</span>
        @enderror
      </div>
