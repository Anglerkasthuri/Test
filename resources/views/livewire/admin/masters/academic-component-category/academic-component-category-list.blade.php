...
<div>
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <h1>Academic Component Category</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Academic Component Category</li>
                    </ol>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div wire:ignore class="filter-section collapse" id="filter_collapse">
                                @include('livewire.admin.masters.academic-component-category.academic-component-category-filter')
                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th wire:click="sortBy('title')"
                                                ...
                                                Academic Component Category</th>                     
    ...
    <x-common.modal wire:key="{{ now() }}"
        ...
        <x-slot name="modal_title">
            Academic Component Category
        </x-slot>
        <x-slot name="modal_size">
            modal-lg
        </x-slot>
        <x-slot name="modal_body">
            @include('livewire.admin.masters.academic-component-category.academic-component-category-create')
        </x-slot>
    </x-common.modal>
