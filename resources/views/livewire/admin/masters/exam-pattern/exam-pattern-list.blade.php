...
<div>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div wire:ignore class="filter-section collapse" id="filter_collapse">
                                @include('livewire.admin.masters.exam-pattern.exam-pattern-filter')
                            </div>
                                                ...
                                                <td>
                                                    <button data-toggle="modal" data-target="#modalCreate"
                                                        ...
                                                        class="btn btn-icon text-primary btn-xs"><i
                                                            ...
                                                            <a href="{{ route('exam-pattern.setting',$record->id) }}">
    ...
    <x-common.modal wire:key="{{ now() }}"
        ...
        <x-slot name="modal_body">
            @include('livewire.admin.masters.exam-pattern.exam-pattern-create')
        </x-slot>
    </x-common.modal>
