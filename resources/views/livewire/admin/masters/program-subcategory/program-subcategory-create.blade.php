  ...
  <form autocomplete="off">
    <div class="row p-3">
      ...
      <div class="form-group col-lg-3">
        {!! Form::label('fdata.title', 'Program Subcategory', ['class' => 'control-label required']) !!}
        {!! Form::text('fdata.title', old('fdata.title'), ['wire:model.defer' => 'fdata.title', 'class' => 'form-control ' . ($errors->has('fdata.title') ? ' is-invalid' : ''), 'placeholder' => 'Enter Program Subcategory']) !!}
        @error('fdata.title')
      ...
      <div class="form-group col-lg-3">
        ...
        {!! Form::select('fdata.program_category_id', $this->programCategoryList, '', ['wire:model' => 'fdata.program_category_id', 'id' => 'fdata.program_category_id', 'class' => 'form-control  ' . ($errors->has('fdata.program_category_id') ? ' is-invalid' : ''), 'placeholder' => 'Select Program Category']) !!}
      ...
      <div class="form-group col-lg-3">
        {!! Form::label('fdata.sequence_number', 'Sequence', ['class' => 'control-label']) !!}
