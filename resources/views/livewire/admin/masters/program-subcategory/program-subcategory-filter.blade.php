<form autocomplete="off">
    <div class="row">
        ...
        <div class="form-group form-focus col-3">
            ...
            {!! Form::label('search.title', 'Program Subcategory', ['class' => 'focus-label']) !!}
        </div>
        ...
        <div class="form-group form-focus col-3">
            {!! Form::select('search.program_category_id', $this->searchProgramCategoryList, 'S', ['wire:model.defer' => 'search.program_category_id', 'class' => 'form-control input-rounded search-input select2 floating', 'placeholder' => '']) !!}
            {!! Form::label('search.program_category_id', 'Program Category', ['class' => 'focus-label']) !!}
        </div>
