...
<div class="row">
  ...
  <div class="form-group form-focus col-3">
      ...
      {!! Form::label('search.title', 'Master Category', ['class' => 'focus-label']) !!}
  </div>
  <div class="form-group form-focus col-3">
  ...
  <div class="form-group form-focus col-3">
    {!! Form::select('search.master_group_id', $this->masterGroupList, 'S', ['wire:model.defer' => 'search.master_group_id', 'class' => 'form-control input-rounded search-input floating select2', 'placeholder' => '']) !!}
    {!! Form::label('search.master_group_id', 'Master Group', ['class' => 'focus-label']) !!}
  </div>
