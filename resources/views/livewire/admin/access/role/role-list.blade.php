...
<div>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div wire:ignore class="filter-section collapse" id="filter_collapse">
                                @include('livewire.admin.access.role.role-filter')
                            </div>
                                ...
                                <table class="table table-head-fixed text-nowrap" wire:loading.class="loading">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>#</th>
                                            <th wire:click="sortBy('name')" class="{{ $this->sortFieldData['name']['css_class'] ?? 'sortby' }}">Role</th>
                                        ...
                                        @forelse($records  as $index => $record)
                                            <tr>
                                                <td>
                                                    ...
                                                    <a href="{{ route('role.permissions.index', ["role" => $record->id ]) }}" data-toggle="popover" data-trigger="hover" data-content="Add Permission" data-placement="top">
    ...
    <div class="modal_section" >
        ...
        :modal_section_id="'modalCreate'" >
            <x-slot name="modal_title">Role</x-slot>
            <x-slot name="modal_size">modal-lg</x-slot>
            <x-slot name="modal_header_action"></x-slot>
            <x-slot name="modal_body">
                @include('livewire.admin.access.role.role-create')
            </x-slot>
        </x-common.modal>
    </div>
