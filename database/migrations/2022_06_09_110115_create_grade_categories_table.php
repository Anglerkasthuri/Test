...
class CreateGradeCategoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('grade_categories', function (Blueprint $table) {
            ...
            $table->boolean('internal_calculation_available')->default(true);
            $table->boolean('external_calculation_available')->default(true);
            $table->boolean('final_calculation_available')->default(true);
