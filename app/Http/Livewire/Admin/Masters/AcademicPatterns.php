...
class AcademicPatterns extends AdminComponent
{
    
    public $page_title = "Academic Pattern";

    public function render()
    {
        $records = $this->index();
        return view('livewire.admin.masters.academic-pattern.academic-pattern-list', compact('records'));
    }

    public function mount()
    {
        $this->model = new AcademicPattern;
    }
    ...
    public function validation_rules()
    {
        ...
        $attributes['fdata.title'] = 'Academic Pattern Name';
