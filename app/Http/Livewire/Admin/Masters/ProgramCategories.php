...
class ProgramCategories extends AdminComponent
{
    use Sequenceable;
    
    public $page_title = "Program Category";
    ...
    {
        $records = $this->index();
        return view('livewire.admin.masters.program-category.program-category-list', compact('records'));
    }
