...
class MasterGroups extends AdminComponent
{
    use Sequenceable;

    public $page_title = "Master Group";
    ...
    {
        $records = $this->index();
        return view('livewire.admin.masters.master-group.master-group-list', compact('records'));
    }
    ...
    {
        $query = $this->model->with([])->withCount('master_category');
