...
class GradeTypes extends AdminComponent
{
    use Sequenceable;

    public $page_title = "Grade Type";
    ...
    {
        $records = $this->index();
        return view('livewire.admin.masters.grade-type.grade-type-list', compact('records'));
    }
    
    public function mount()
    {
        $this->model = new GradeType;
    }
    ...
    public function validation_rules()
    {
        $rules = [
            ...
            'fdata.code' => ['required', 'max:100', 'alpha_numeric_with_special_chars', "unique:". $this->model->getTable() .",code,$this->record_id,id"], // 'alpha_numeric_with_special_chars', 
        ...
        $attributes['fdata.title'] = 'Grade Type';
