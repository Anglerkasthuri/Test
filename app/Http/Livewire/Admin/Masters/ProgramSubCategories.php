...
class ProgramSubCategories extends AdminComponent
{
    use Sequenceable;
    
    public $page_title = "Program Subcategory";
    ...
    {
        $records = $this->index();
        return view('livewire.admin.masters.program-subcategory.program-subcategory-list', compact('records'));
    }

    public function mount()
    {
        $this->model = new ProgramSubCategory;
    }
    ...
    public function applySearchFilter($query) 
    {
        ...
        $conditions['in']['program_category_id'] = Arr::get($this->search, 'program_category_id');
    ...
    public function validation_rules()
    {
        ...
        $attributes['fdata.title'] = 'Program Category Name';
