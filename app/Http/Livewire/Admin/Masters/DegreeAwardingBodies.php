...
class DegreeAwardingBodies extends AdminComponent
{

    public $page_title = "Degree Awarding Body";  

    public function render()
    {
        $records = $this->index();
        return view('livewire.admin.masters.degree-awarding-body.degree-awarding-body-list', compact('records'));
    }

    public function mount()
    {
        $this->model = new DegreeAwardingBody;
    }
    ...
    public function validation_rules()
    {
        ...
        $attributes['fdata.title'] = 'Degree Awarding Body';
